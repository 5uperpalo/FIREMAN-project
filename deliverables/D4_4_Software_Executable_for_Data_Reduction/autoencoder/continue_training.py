...
if __name__ == "__main__":
    ...
    # help with norm params
    norm_parameters = {"min_val": [], "max_val": []}
    norm_parameters["min_val"] = np.loadtxt(normalization_params_dir + "min_val")
    norm_parameters["max_val"] = np.loadtxt(normalization_params_dir + "max_val")
    norm_data = data_loader_autoencoder_use_my_own_norm(data_name, norm_parameters, lags, skip_rows, normalization_params_dir)
    # end help with norm params
    ...
    continue_train_autoencoder(model, norm_data, model_parameters, model_dir)
